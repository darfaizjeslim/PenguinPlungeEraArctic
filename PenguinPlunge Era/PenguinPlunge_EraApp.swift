...
@main
struct PenguinPlunge_EraApp: App {
...
class ServerResponseHandler: ObservableObject {
    ...
    private var serverURL: String {
        if let url = Bundle.main.object(forInfoDictionaryKey: "ServerBaseURL") as? String {
            return url + "/ios-penguin-plunge-era-arctic/server.php"
        }
        return "https://gtappinfo.site/ios-penguin-plunge-era-arctic/server.php"
    }
